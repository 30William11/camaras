          ...
          <div class="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl p-8 text-white h-full">
            ...
            <div class="space-y-6">
              ...
              <div class="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p class="text-blue-100">+123 456 7891</p>
                </div>
              </div>
              ...
              <div class="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p class="text-blue-100">info@cctvpro.com</p>
                  <p class="text-blue-100">ventas@cctvpro.com</p>
                </div>
              </div>
              ...
              <div class="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p class="text-blue-100">Lunes - Viernes: 9:00 AM - 6:00 PM</p>
                  <p class="text-blue-100">Sábado: 9:00 AM - 1:00 PM</p>
                </div>
              </div>
            </div>
            ...
            <div class="mt-8 pt-8 border-t border-white/20">
              ...
              <div class="flex gap-3">
                <a href="#" class="w-10 h-10 rounded-lg bg-white/20 hover:bg-white/30 flex items-center justify-center transition-colors">
