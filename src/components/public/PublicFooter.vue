      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          <div class="flex items-center gap-2 mb-4">
            <div class="w-10 h-10 rounded-lg bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-center shadow-lg">
          ...
          <div class="flex gap-3">
            <a
              ...
              class="w-10 h-10 rounded-lg bg-slate-800 hover:bg-blue-600 flex items-center justify-center transition-colors"
            >
        ...
        <div>
          ...
          <ul class="space-y-3 text-sm">
            <li class="flex items-start gap-2">
              ...
              <span>Dirección de tu empresa</span>
            </li>
            <li class="flex items-center gap-2">
              <svg class="w-5 h-5 text-blue-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <a href="mailto:info@cctvpro.com" class="hover:text-blue-400 transition-colors">
                info@cctvpro.com
              </a>
            </li>
            <li class="flex items-center gap-2">
              ...
              <a href="tel:+1234567890" class="hover:text-blue-400 transition-colors">
                +123 456 7890
              </a>
            </li>
          </ul>
